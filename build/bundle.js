var app = (function () {
    ...
    /* src\node_modules\components\HowTo.svelte generated by Svelte v3.22.2 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="images/handwashing.png" alt="How to wash your hands" class="svelte-p4464p">`;
    			t0 = space();
    			h3 = element("h3");

    			h3.innerHTML = `<a href="https://www.who.int/gpsc/clean_hands_protection/en/">Picture source</a> 
  <a href="https://www.who.int/gpsc/clean_hands_protection/en/">Sound source</a>`;

    			attr(div, "bp", "grid");
    			attr(h3, "class", "svelte-p4464p");
    		},
    		m(target, anchor) {
    ...
    /* src\node_modules\components\ProgressBar.svelte generated by Svelte v3.22.2 */
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			span = element("span");
    			span.textContent = "%";
    			attr(div0, "class", "progress-bar svelte-12v6zy2");
    			set_style(div0, "width", /*value*/ ctx[0] + "%");
    			attr(span, "class", "sr-only");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-12v6zy2");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    class ProgressBar extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance, create_fragment$1, safe_not_equal, { value: 0 });
    	}
    }

    /* src\node_modules\components\Timer.svelte generated by Svelte v3.22.2 */
    ...
    function create_fragment$2(ctx) {
    	...
    	let current;
    	let dispose;
    	const progressbar = new ProgressBar({ props: { value: /*value*/ ctx[2] } });
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*value*/ 4) progressbar_changes.value = /*value*/ ctx[2];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondsLeft*/ 1) {
    			 $$invalidate(4, secondsElapsed = totalSeconds - secondsLeft);
    		}

    		if ($$self.$$.dirty & /*secondsElapsed*/ 16) {
    			 $$invalidate(2, value = secondsElapsed * 100 / totalSeconds);
    		}
    	};

    	return [secondsLeft, isRunning, value, start];
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	timer.$on("done", /*done_handler*/ ctx[1]);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [audio, done_handler, audio_1_binding];
    }
